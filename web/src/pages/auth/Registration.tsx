    ...
    <div className="flex flex-col justify-center min-h-screen py-12 bg-gray-50 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-sm text-center text-gray-600 max-w">
          Or&nbsp;
          <a href="http://127.0.0.1:4433/self-service/login/browser" className="font-medium text-indigo-600 hover:text-indigo-500">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
          <AuthForm data={data} actionLabel="Sign up" />
          <div className="mt-6">
